...
CAFEE_IMAGES_PATH = os.path.join(BASE_DIR, "dataset" ,"images_etd1a") #os.path.join(BASE_DIR, 'dataset/images/')
...
TEST_CAFEE_IMAGES_PATH = os.path.join(BASE_DIR, "dataset", "images_etd1a") # Please use CAFEE_IMAGES_PATH in deployement and delete this # USUAGE so far 
